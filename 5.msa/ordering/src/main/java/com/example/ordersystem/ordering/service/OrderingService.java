...
//            product서버에 api요청을 통해 product객체를 받아와야함 -> 동기적처리 필수
            String productGetUrl = "http://hans-msa-product-service/product/"+o.getProductId();
...
//                재고감소 api요청을 product서버에 보내야함 -> 비동기처리 가능
                String productUpdateStockUrl =  "http://hans-msa-product-service/product/updatestock";
